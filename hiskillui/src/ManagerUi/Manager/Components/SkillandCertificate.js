...
import Group6122 from '../assets/login assets/Group 612 (2).svg'
import Group6111 from '../assets/login assets/Group 611 (1).svg'
import Rectangle189 from '../assets/login assets/Rectangle 189.svg'
     ...
     style={{
      ...
      <img    
       ...
       alt="Group621 not found"
        ...
        <img 
        src={Group6122} 
        alt="Group 6122 not found"
        style={{
            position:'absolute',
            top:'463px',
            width:'250px',
            left:'15px',
            backgroundColor:'#FFBFB4',
            cursor:'pointer'
        }}
         />
        <img 
